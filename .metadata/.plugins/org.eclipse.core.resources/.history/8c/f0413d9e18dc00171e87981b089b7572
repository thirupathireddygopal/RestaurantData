	...
	<div class="page">
		...
		<div id="login">
			...
			<form name="login_form" action="UrbanspoonController" method="post">
				...
				<label>Login As</label> <input type="radio" name="loginAs" value="user"> User 
		...
		<div id="restaurant_registration">
			...
			<form name="restaurant_registration_form" method="post" action="UrbanspoonController" enctype="multipart/form-data">
				<input type="hidden" name="action" value="restaurant_registration">
				<label>Name</label>							<input type="text" name="name"><br> 
				<label>Government Registration ID</label>	<input type="text" name="govt_registration_id"><br>
				<label>Restaurant Logo</label>				<input type="file" name="registration_logo"><br> 
				<label>Password</label>						<input type="password" name="password"><br> 
				<label>Confirm Password</label>				<input type="password" name="confirm_password"> <br>
															<input type="submit" value="register">
			</form>
